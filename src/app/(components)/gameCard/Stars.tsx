...
export default function Stars({ gameID }: StarsProps) {
  ...
  return (
    ...
    <div className="display-inherit gap-1 group  items-center place-items-center">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1"
        ...
        stroke="currentColor"
        className="h-6 w-6 shrink-0 cursor-pointer bottom-0.5 hover:scale-110 flex items-center justify-center absolute right-0">
        <path strokeLinecap="round" strokeLinejoin="round" textAnchor="middle"
