...
${isOpen ? 'scale-x-100 opacity-100' : 'opacity-70 -scale-x-50'} overflow-x-hidden`}>
          <Image unoptimized src={'/mlogo.png'} alt='a1Th logo' quality={100} width={112} height={32} className='absolute right-4 top-4' sizes="(max-width: 404px) 100vw , (max-width: 768px) 60vw, (min-width: 769px) 30vw" />
