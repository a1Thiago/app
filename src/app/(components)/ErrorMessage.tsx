...
export default function ErrorMessage({ error }: ErrorProps) {
  ...
  return (
    <div className='grid col-span-full text-center space-y-28 mobile:space-y-16  place-items-center p-4 py-16 mobile:py-8'>
      <p className='text-24 tablet:text-20 mobile:text-16 font-semibold'>{error}</p>
      <Image unoptimized className='animate-bounce-slow my-12' src={'/error.png'} alt='error image' width={200} height={200} />
